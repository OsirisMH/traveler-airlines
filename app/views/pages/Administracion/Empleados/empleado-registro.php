    ...
    <main>
        <div class = "container datos-pasajeros py-4">
            <div class = "titulo d-flex justify-content-between py-1 px-3">
                <h4 class = "text-uppercase font-weight-bold text-light d-inline" id = "titulo">REGISTRO DE EMPLEADO</h4>
            ...
            <form action="<?php echo RUTA_URL?>/paginas/administrar_registro_empleado" class = "py-3" method="POST">
                <div class="form-group">
                    <div class="form-group row txtNombre">
                        <label for="inputNombre" class="col-sm-2 col-form-label">Nombre:</label>
                        <div class="col-sm-10">
                        <input required pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" title= "¡No se permiten números!" type="text" class="form-control" name = "NombreEmpleado" id="inputNombre" placeholder="Nombre">
                        </div>
                    </div>
                    <div class="form-group row txtApellido">
                        <label for="inputApellido" class="col-sm-2 col-form-label">Apellido:</label>
                        <div class="col-sm-10">
                        <input required pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" title= "¡No se permiten números!" type="text" class="form-control" name = "ApellidoEmpleado" id="inputApellido" placeholder="Apellido">
                        </div>
                    </div>
                    <div class="form-group row txtFechaNacimiento">
                        ...
                        <div class="col-sm-10">
                        <input required type="date" class="form-control" name = "FechaNacimientoEmpleado" id="inputFechaNacimiento" value = "">
                        </div>
                    </div>
                    <div class="form-group row txtSexo">
                        <legend class="col-form-label col-sm-2 pt-0">Sexo:</legend>
                        <div class="form-check form-check-inline pl-3">
                            <input required checked class="form-check-input" type="radio" name="sexo" id="radioMasculino" value="M">
                ...
                <div class="form-group">
                    <div class="form-group row txtCorreo">
                        ...
                        <div class="col-sm-10">
                        <input required type="email" class="form-control" name = "CorreoEmpleado" id="inputCorreo" placeholder="Correo Electronico">
                        </div>
                    </div>
                    <div class="form-group row txtTelefono" id = "phone-number">
                        <label for="inputTelefono" class="col-sm-2 col-form-label">Telefono:</label>
                        <div class="col-sm-10">
                        <input required type="text" class="form-control" name = "TelefonoEmpleado" id="inputTelefono" placeholder="Telefono">
                        </div>
                    </div>
