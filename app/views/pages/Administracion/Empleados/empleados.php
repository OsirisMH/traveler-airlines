...
<body>
    ...
    <main>
        <div class="container-fluid px-5 py-4">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="empleados-tab" data-toggle="tab" href="#empleados" role="tab" aria-controls="empleados" aria-selected="true">Empleados</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="empleados" role="tabpanel" aria-labelledby="empleados-tab">
                    <div class="col-12">
                        <div class="form-inline py-3">
                            <div class="form-group w-50">
                                ...
                                <input type="search" class="form-control w-75" id="busqueda" placeholder="Nombre...">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 py-3 text-center">
                        <a href = "<?php echo RUTA_URL?>/paginas/administrar_registro_empleado?accion=registrar" class = "btn btn-outline-primary mx-3" id = "btnRegistrarEmpleado">Registrar</a>
                        <a href = "#" class = "btn btn-outline-primary mx-3" id = "btnEditarEmpleado">Editar</a>
                ...
                <div class="tab-pane fade" id="usuarios" role="tabpanel" aria-labelledby="usuarios-tab">
                    <div class="col-12">
                        <div class="form-inline py-3">
                            <div class="form-group w-50">
                                <label for="busquedaUsuario" class="text-uppercase font-weight-bold pr-4">Buscar</label>
                                <input type="search" class="form-control w-75" id="busquedaUsuario" placeholder="Nombre...">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 py-3 text-center">
                        ...
                        <a href = "<?php echo RUTA_URL?>/paginas/administrar_registro_empleado_usuario?accion=registrar" class = "btn btn-outline-primary mx-3" id = "btnRegistrarUsuario">Registrar</a>
                        <a href = "#" class = "btn btn-outline-primary mx-3" id = "btnEditarUsuario">Editar</a>
    ...
    <script src="<?php echo RUTA_URL?>/js/empleados.js"></script>
    <script>
    $( document ).ajaxStop(function() {
        var idEmpleado = "";
        $("#data table tr").click(function(){
            $(this).addClass('table-active').siblings().removeClass('table-active');
            idEmpleado = $("td:first-child", this).text();
            $("#btnEditarEmpleado").attr('href', '<?php echo RUTA_URL?>/paginas/administrar_modificar_empleado/'+idEmpleado);
        });

        var idUsuario = "";
        $("#UserData table tr").click(function(){
            $(this).addClass('table-active').siblings().removeClass('table-active');
            idUsuario = $("td:first-child", this).text();
            $("#btnEditarUsuario").attr('href', '<?php echo RUTA_URL?>/paginas/administrar_registro_empleado_usuario?accion=editar&id='+idEmpleado);
        });
    });
    </script>
</body>
